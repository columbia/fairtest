...
in Table~\ref{tab:fairtestApi}. As shown, this API contains very simple
operations to be linked into the application. Being a RESTful API, it has
support for most programming languages to add outputs directly from the
MVC models. It also offers a simple querying mechanism for developers
to check validity of data. Since the data model is simple, we expect
the API to be scalable as well.
