...
def create_contexts(classes, pool, guard_lines, random_suffix, effect):
    """
...
def do_benchmark(data_dict, classes, random_suffix, sens=SENS, target=TARGET,
...
def make_plot(data, n_iterations):
    ...
    plt.ylabel("Effect Size for Successful Discovery (#iterations: {})".format(n_iterations))
