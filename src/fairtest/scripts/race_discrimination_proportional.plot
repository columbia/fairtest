...
set xlabel "User visits grouped by user races (8 different races)"
...
plot newhistogram, "race_discrimination_proportional.csv"\
  u 5:xticlabels(1) t "Low price" lc rgbcolor "black" lt 1 fs pattern 1,\
  '' u 6:xticlabels(1) t "High price" lc rgbcolor "black" lt 1  fs pattern 3,\
